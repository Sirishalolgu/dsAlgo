Feature: Testing the Linked list page of the Ds algo application
  ...
  Scenario Outline: User is able to navigate to Array using dropdown option
    ...
    Examples: 
      | option | topic                                                                              |
      | Arrays| Arrays in Python,Arrays Using List,Basic Operations in Lists,Applications of Array|
  ...
  Scenario Outline: User is able to navigate to Array next page
    ...
    Examples: 
      | option | topics                                                                                                   |
      | Arrays  | Search the array,Max Consecutive Ones,Find Numbers with Even Number of Digits,Squares of  a Sorted Array |
